...
var ImmutableQuery = /** @class */ (function () {
    ...
    ImmutableQuery.prototype.removeAggs = function () {
        return this.remove("aggs");
    };
    ImmutableQuery.prototype.shouldAppendResults = function () {
        return this.index.shouldAppendResults;
    };
    ImmutableQuery.prototype.setShouldAppendResults = function (shouldAppendResults) {
        return this.update({ $merge: { shouldAppendResults: shouldAppendResults } });
    };
    ImmutableQuery.prototype.remove = function (key) {
        return new ImmutableQuery(omit(this.index, key));
    };
