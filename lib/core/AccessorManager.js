...
var AccessorManager = /** @class */ (function () {
    ...
    AccessorManager.prototype.setState = function (state, _path) {
        each(this.getStatefulAccessors(), function (accessor) { return accessor.fromQueryObject(state, _path); });
    };
    ...
    AccessorManager.prototype.postProcessQuery = function (query) {
        return reduce(this.getActiveAccessors(), function (query, accessor) {
    ...
    AccessorManager.prototype.buildQuery = function () {
        ...
        return this.postProcessQuery(this.buildOwnQuery(this.buildSharedQuery(new query_1.ImmutableQuery())));
    };
